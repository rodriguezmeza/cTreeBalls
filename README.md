...
| `GSLINTERNAL`     | `= 1` for enabling GSL internal sources <br />(If not (`=0`) specify the corresponding compiler flag in `Makefile_machine` file)                                                             |
...
| `PTOPIVOTROTATIONON`    | `= 1` to set an additional rotation to the reference axis each pivot has       |
