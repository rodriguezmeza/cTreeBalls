...
input1=np.loadtxt("../Output/histZetaM_cos_1.txt")
input2=np.loadtxt("../Output/histZetaM_cos_2.txt")
input3=np.loadtxt("../Output/histZetaM_cos_3.txt")
input4=np.loadtxt("../Output/histZetaM_cos_4.txt")
input5=np.loadtxt("../Output/histZetaM_cos_5.txt")
input6=np.loadtxt("../Output/histZetaM_cos_6.txt")
input7=np.loadtxt("../Output/histZetaM_cos_7.txt")
input8=np.loadtxt("../Output/histZetaM_cos_8.txt")
input9=np.loadtxt("../Output/histZetaM_cos_9.txt")
...
input1=np.loadtxt("../Output/histZetaM_sin_1.txt")
input2=np.loadtxt("../Output/histZetaM_sin_2.txt")
input3=np.loadtxt("../Output/histZetaM_sin_3.txt")
input4=np.loadtxt("../Output/histZetaM_sin_4.txt")
input5=np.loadtxt("../Output/histZetaM_sin_5.txt")
input6=np.loadtxt("../Output/histZetaM_sin_6.txt")
input7=np.loadtxt("../Output/histZetaM_sin_7.txt")
input8=np.loadtxt("../Output/histZetaM_sin_8.txt")
input9=np.loadtxt("../Output/histZetaM_sin_9.txt")
...
input1=np.loadtxt("../Output/histZetaM_sincos_1.txt")
input2=np.loadtxt("../Output/histZetaM_sincos_2.txt")
input3=np.loadtxt("../Output/histZetaM_sincos_3.txt")
input4=np.loadtxt("../Output/histZetaM_sincos_4.txt")
input5=np.loadtxt("../Output/histZetaM_sincos_5.txt")
input6=np.loadtxt("../Output/histZetaM_sincos_6.txt")
input7=np.loadtxt("../Output/histZetaM_sincos_7.txt")
input8=np.loadtxt("../Output/histZetaM_sincos_8.txt")
input9=np.loadtxt("../Output/histZetaM_sincos_9.txt")

zetas =[input1/np.mean(input1), input2/np.mean(input2), input3/np.mean(input3),
        input4/np.mean(input4), input5/np.mean(input5), input6/np.mean(input6),
        input7/np.mean(input7), input8/np.mean(input8), input9/np.mean(input9)]
scale = [1, 2, 5, 5, 5, 5, 5, 5, 5]
#fig1 = plt.figure(figsize=(9,6))
#im=plt.imshow(zeta,origin ='lower', cmap='RdBu')
fig1 = plt.figure(figsize=(10, 12))
grid = ImageGrid(fig1, 111, nrows_ncols=(3, 3),
