...
def test_driver_rejects_edge_correction_without_3pcf():
    config = RunConfig(engines=("octree-2balls-mpi",),
                       output_dir=Path("unused"), result_type="edge_effects")
