...
global void searchcalc_normal_omp(bodyptr, int, INTEGER, INTEGER);
...
global int computeBodyProperties_omp_3pcfbf(bodyptr, int, gdhist_omp_3pcfbf);
global int search_compute_HistN_3pcfbf(int nbody);
global void searchcalc_normal_3pcf_direct_omp(bodyptr, int, INTEGER, INTEGER);
//B BALLS4
global int search_init_omp_balls6(gdhistptr_omp_balls6, int);
global int search_init_sincos_omp_balls6(gdhistptr_sincos_omp_balls6);
global int search_init_omp_balls6_cc(gdhistptr_omp_balls6);
global int search_free_omp_balls6(gdhistptr_omp_balls6);
global int search_free_omp_balls6_cc(gdhistptr_omp_balls6);
global int search_free_sincos_omp_balls6(gdhistptr_sincos_omp_balls6);

global int computeBodyProperties_omp_balls6(bodyptr, int, gdhistptr_omp_balls6);
global int computeBodyProperties_omp_balls6_cc(bodyptr, INTEGER,
                                               gdhistptr_omp_balls6);
global int computeBodyProperties_sincos_omp_balls6_cc(bodyptr, INTEGER,
...
#ifdef BALLS
//global void searchcalc_balls_omp(bodyptr, int, INTEGER, INTEGER);
global void searchcalc_balls_omp(bodyptr *, INTEGER *, INTEGER, INTEGER *, int, int);
global int search_init_balls_omp(gdhistptr_omp_balls hist);
global int search_init_balls_omp_cc(gdhistptr_omp_balls hist);
global int computeBodyProperties_balls_omp(bodyptr, int, gdhistptr_omp_balls);
global int computeBodyProperties_balls_omp_cc(bodyptr, int, gdhistptr_omp_balls);
global int computeBodyProperties_balls_omp_cc_sincos(bodyptr, int, gdhistptr_sincos_omp);
