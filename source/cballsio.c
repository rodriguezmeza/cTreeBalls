...
// Check the center of the box!!!
    ...
    verb_print(cmd->verbose, 
               "inputdata_ascii: average of kappa (%ld particles) = %le\n",
...
//
// Freeing allocated must consider the allocated memory by others, Task != 0.
//  See StartRun.
//
    if (cmd->computeTPCF) {
