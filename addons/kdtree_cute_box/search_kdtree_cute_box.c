...
// Adapted as an AddOn to cBalls
//  by Mario A. Rodríguez-Meza
//  2024.04.27
...
// search=kdtree-cute-box
global void searchcalc_kdtree_cute_box(struct cmdline_data* cmd,
...
*/
//    sprintf(fnameIn,"%s","params_cute_box.txt");
    sprintf(fnameIn,"%s",cmd->options);
