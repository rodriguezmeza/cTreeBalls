/* ==============================================================================
 MODULE: search_octree_sincos_omp.c		[cTreeBalls]
...
/*
 ...
 To be called using: search=octree-sincos-omp-addons (substitute tree-omp-sincos)
 ...
 */
global int searchcalc_octree_sincos_omp_addons(struct  cmdline_data* cmd,
                                 struct  global_data* gd,
                                 ...
                                 int cat1, int cat2)
{
    ...
    verb_print(cmd->verbose,
               "\nEvalHistograms: Running ... (octree-sincos-omp-addons) \n");
