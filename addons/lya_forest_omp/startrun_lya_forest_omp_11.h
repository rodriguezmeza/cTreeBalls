...
if (strcmp(method_str, "lya-los-tree-2pcf-omp") == 0)
    *method_int = LYAFORESTLOSTREE2PCFMETHOD;
if (strcmp(method_str, "lya-los-tree-3pcf-omp") == 0)
    *method_int = LYAFORESTLOSTREE3PCFMETHOD;
if (strcmp(method_str, "lya-los-tree-2pcf-3pcf-omp") == 0)
    *method_int = LYAFORESTLOSTREE2PCF3PCFMETHOD;
