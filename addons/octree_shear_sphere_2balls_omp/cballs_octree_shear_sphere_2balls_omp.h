#ifndef _cballs_octree_shear_sphere_2balls_omp_h
#define _cballs_octree_shear_sphere_2balls_omp_h

case OCTREESHEARSPHERE2BALLSOMPMETHOD:
{
    int shear_cat1;
    int shear_cat2;
    int shear_cat3;
    ...
    verb_print_normal_info(
        ...
        "\n\tevalHist: with octree-shear-sphere-2balls-omp method\n\n");
    ...
    if (searchcalc_octree_shear_sphere_2balls_omp(
