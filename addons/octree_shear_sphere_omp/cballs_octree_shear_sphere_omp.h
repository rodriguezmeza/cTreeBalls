#ifndef _cballs_octree_shear_sphere_omp_h
#define _cballs_octree_shear_sphere_omp_h

case OCTREESHEARSPHEREMETHOD:
{
    int shear_cat1;
    int shear_cat2;
    int shear_cat3;
    ...
    verb_print_normal_info(cmd->verbose, cmd->verbose_log, gd->outlog,
                           "\n\tevalHist: with octree-shear-sphere-omp method\n\n");
    ...
    if (searchcalc_octree_shear_sphere_omp(
